      ...
      <div class="camera_caption absolute inset-0">
        <div class="container mx-auto flex h-full max-w-7xl items-center justify-center px-4">
          <div class="mx-auto w-full max-w-3xl text-center">
            <h1
              class="text-4xl font-extrabold tracking-tight text-primary-700 sm:text-6xl"
              data-animate
            ...
            <h2
              class="mt-3 text-3xl font-bold tracking-tight text-main-800 sm:text-5xl"
              data-animate
              style="--animate-duration: 0.8s; animation-delay: 0.2s;"
            >
              ${safeSubtitle}
            </h2>
            <div class="mt-8 flex justify-center" data-animate style="--animate-duration: 0.8s; animation-delay: 0.39s;">
              <a
                href="${safeHref}"
                class="inline-flex items-center justify-center rounded-md bg-main-0 px-5 py-4 text-sm font-semibold text-primary-900 shadow-sm transition hover:bg-primary-700 hover:text-main-50 uppercase focus:outline-none focus:ring-2 focus:ring-main-0/40"
              >
                ${safeCta}
              </a>
            </div>
