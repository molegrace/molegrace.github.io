      ...
      <div class="camera_caption absolute inset-0">
        <div class="container mx-auto flex h-full max-w-7xl items-center justify-center px-4">
          <div class="mx-auto w-full max-w-3xl text-center">
            <h1
              class="hero-caption-item overflow-hidden text-3xl font-extrabold leading-tight tracking-tight text-primary-700 sm:text-6xl"
              data-animate
            ...
            <h2
              class="hero-caption-item mt-2 overflow-hidden text-2xl font-bold leading-tight tracking-tight text-main-800 sm:mt-3 sm:text-5xl"
              data-animate
              style="--animate-duration: 0.8s; animation-delay: 0.2s;"
            >
              ${safeSubtitle}
            </h2>
            <div class="hero-caption-item mt-6 flex justify-center overflow-hidden sm:mt-8" data-animate style="--animate-duration: 0.8s; animation-delay: 0.39s;">
              <a
                href="${safeHref}"
